  ...
  >
    ...
    <div className="content">
      <div className="py-1">
        ...
        {acm ? (
          <Button href={acm} variant="warning" size="sm" className="mr-1">
            ACM
          </Button>
        ) : undefined}
        {ieee ? (
          <Button href={ieee} variant="warning" size="sm" className="mr-1">
            IEEE
          </Button>
        ) : undefined}
        {bibtex ? (
          ...
          >
            <i className="fa fa-clipboard mr-inline" /> Copy BibTeX to clipboard
          </Button>
        ) : undefined}
        {inPrint ? (
          <span className="badge badge-pill badge-success">In Print</span>
        ) : undefined}
      </div>
    </div>
  </TileItem>
...
const Research = () => (
  <Layout pageInfo={{ name: 'research', title: 'Research' }}>
    <SEO title="Research" />
    <Row>
      <PublicationItem
