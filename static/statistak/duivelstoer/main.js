...
var map = {
	"../pages/backup/backup.module": [
		"./src/app/pages/backup/backup.module.ts",
		"default~pages-backup-backup-module~pages-charts-charts-module~pages-optreden-optreden-module~pages-o~04ca5628",
		"common",
		"pages-backup-backup-module"
	],
	...
	"../pages/optredens/optredens.module": [
		"./src/app/pages/optredens/optredens.module.ts",
		"default~pages-backup-backup-module~pages-charts-charts-module~pages-optreden-optreden-module~pages-o~04ca5628",
		"common",
		"pages-optredens-optredens-module"
	],
	"../pages/repertoire/repertoire.module": [
		"./src/app/pages/repertoire/repertoire.module.ts",
		"default~pages-backup-backup-module~pages-charts-charts-module~pages-optreden-optreden-module~pages-o~04ca5628",
		"common",
		"pages-repertoire-repertoire-module"
	],
	"../pages/statistiek/statistiek.module": [
		"./src/app/pages/statistiek/statistiek.module.ts",
		"default~pages-backup-backup-module~pages-charts-charts-module~pages-optreden-optreden-module~pages-o~04ca5628",
		"common",
		"pages-statistiek-statistiek-module"
	],
	"../pages/stuk/stuk.module": [
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            if (window.AndroidNotch) {
                var style_1 = document.documentElement.style;
                window.AndroidNotch.getInsetTop(function (px) {
                    style_1.setProperty('--ion-safe-area-top', px + 'px');
                }, function (err) { return console.error('Failed to get insets top:', err); });
            }
        });
    };
...
module.exports = __webpack_require__(/*! D:\WebStormProjects\statistak\src\main.ts */"./src/main.ts");
